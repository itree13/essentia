...
class RhythmExtractor : public AlgorithmComposite {
 ...
 public:
  ...
  void declareParameters() {
    ...
    declareParameter("tempoHints", "the optional list of initial beat locations, to favor the detection of pre-determined tempo period and beats alignment [s]", "", ::essentia::VectorEx<Real>());
