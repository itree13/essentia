...
TEST(FileOutput, Real) {
  ...
  string line;
  ::essentia::VectorEx<Real> vectorLine = arrayToVector<Real>(inputData);
  ::essentia::VectorEx<Real> results;
...
TEST(FileOutput, String) {
  ...
  fileStream.open(filename.c_str());
  string line;
  ::essentia::VectorEx<string> vectorLine = arrayToVector<string>(inputData);
  ::essentia::VectorEx<string> results;
...
TEST(FileOutput, VectorReal) {
  ...
  ::essentia::VectorEx<::essentia::VectorEx<Real> > inputData;
  ...
  streaming::Algorithm* gen = new VectorInput<::essentia::VectorEx<Real> >(&inputData);
  streaming::Algorithm* file = new FileOutput<::essentia::VectorEx<Real> >();
  file->configure("filename", filename, "mode", "text");
  ...
  ifstream fileStream;
  fileStream.open(filename.c_str());
  ::essentia::VectorEx<string> lines;
  string line;
...
TEST(FileOutput, VectorString) {
  ...
  ::essentia::VectorEx<::essentia::VectorEx<string> > inputData;
  ...
  streaming::Algorithm* gen = new VectorInput<::essentia::VectorEx<string> >(&inputData);
  streaming::Algorithm* file = new FileOutput<::essentia::VectorEx<string> >();
  file->configure("filename", filename, "mode", "text");
...
TEST(FileOutput, VectorComplexReal) {
  ...
  ::essentia::VectorEx<::essentia::VectorEx<complex<Real> > > inputData;
  ...
  streaming::Algorithm* gen = new VectorInput<::essentia::VectorEx<complex<Real> > >(&inputData);
  streaming::Algorithm* file = new FileOutput<::essentia::VectorEx<complex<Real> > >();
  file->configure("filename", filename, "mode", "text");
...
TEST(FileOutput, Array1D) {
  ...
  ::essentia::VectorEx<TNT::Array1D<Real> > inputData;
...
TEST(FileOutput, Array2D) {
  ...
  ::essentia::VectorEx<TNT::Array2D<Real> > inputData;
